var pickerDatetime = function(obj) {
  ...
  if (obj.animation == 'slide' || obj.animation == 'fade') {
    ...
    this.page.pickerOk = function () {
      ...
      _this.pickerTimeout = setTimeout(function() {
        // _this.page.setData({ pickerViewShow: false });
        _this.page.setData({ pickerViewShow: false, timePaneHide: true,hideTimePane:true });
      },_this.duration);
      _this.success();
    };
  } else {
    ...
    this.page.pickerOk = function(){
      ...
      this.setData({ pickerViewShow: false,timePaneHide:true, hideTimePane: true });
      _this.success();
    };
  }
...
pickerDatetime.prototype.setPicker = function(pickerName) {
  ...
  if (this.page.data[pickerName] == undefined || this.page.data[pickerName] == '') {
    ...
    if (pickerName == "startTime") {
      var pickerPreHour = '00';
      var pickerPreMinute = '00';
    }
    else if (pickerName == "endTime") {
      var pickerPreHour = '23';
      var pickerPreMinute = '59';
    }
    var obj = new Object();
  ...
  if (pickerName == "startTime") {
    var pickerNowHour = '00';
    var pickerNowMinute = '00';
  }
  else if (pickerName == "endTime") {
    var pickerNowHour = '23';
    var pickerNowMinute = '59';
  }
